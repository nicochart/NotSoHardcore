...
public class NSHConfig
{
    ...
    public boolean alwaysRenderHardcoreHearts = true; //true = render health bar like in hardcore mode

    public NSHConfig() {}
    public NSHConfig(int maxLives, int timeToRegainLife, boolean creativeResetsLifeCount, boolean useRealtimeRegain, boolean alwaysRenderHardcoreHearts)
    {
        ...
        this.alwaysRenderHardcoreHearts = alwaysRenderHardcoreHearts;
    }
}
