...
public final class NSHCommands
{
    ...
    private static void registerImpl(CommandDispatcher<ServerCommandSource> dispatcher, net.minecraft.registry.RegistryWrapper.WrapperLookup registryAccess, CommandManager.RegistrationEnvironment env) {
        ...
        dispatcher.register(CommandManager.literal("nsh")
                .requires(src -> src.hasPermissionLevel(2))
                .then(CommandManager.literal("useRealtime")
                ...
                .then(CommandManager.literal("creativeResetsLifeCount")
                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                .executes(ctx -> {
                                    boolean value = BoolArgumentType.getBool(ctx, "value");
                ...
                .then(CommandManager.literal("alwaysRenderHardcoreHearts")
                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                .executes(ctx -> {
                                    boolean value = BoolArgumentType.getBool(ctx, "value");
                ...
                .then(CommandManager.literal("maxLives")
                ...
                .then(CommandManager.literal("respawn")
                        .then(CommandManager.argument("player", EntityArgumentType.player())
                                .executes(context -> {
                                    ...
                                    {
                                        throw new SimpleCommandExceptionType(Text.translatable("commands." + NotSoHardcore.MOD_ID + ".respawn.already_alive")).create();
                                    }
    ...
    {
        return CommandManager.literal(timeUnit)
